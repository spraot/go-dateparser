...
func TestTranslate_relative(t *testing.T) {
	...
	tests := []testScenario{
		...
		{"en", "10h11", "10:11"},
		{"en", "10h11m", "10 hour 11 minute"},
		{"en", "3d8h2m", "3 day 8 hour 2 minute"},
		{"en", "5d9h59m10s", "5 day 9 hour 59 minute 10 second"},
		{"en", "3d1h", "3 day 1 hour"},
		{"en", "3d29m", "3 day 29 minute"},
		{"en", "1.5d10s", "1.5 day 10 second"},
		{"en", "7m1s", "7 minute 1 second"},
		// German
